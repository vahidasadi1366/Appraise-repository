...
class DirectAssessmentDocumentTaskAdmin(DirectAssessmentContextTaskAdmin):
    ...
    pass
class DirectAssessmentLongDocumentTaskAdmin(DirectAssessmentContextTaskAdmin):
    """
    Model admin for DirectAssessmentDocumentTask instances.
    """

    pass
class DirectAssessmentDocLevelDAWindowTaskAdmin(DirectAssessmentContextTaskAdmin):
    """
    Model admin for DirectAssessmentDocumentTask instances.
    """
...
class DirectAssessmentDocumentResultAdmin(DirectAssessmentContextResultAdmin):
    ...
    pass
class DirectAssessmentDocLevelDAWindowResultAdmin(DirectAssessmentContextResultAdmin):
    """
    Model admin for DirectAssessmentDocumentResult instances.
    """

    pass
class DirectAssessmentLongDocumentResultAdmin(DirectAssessmentContextResultAdmin):
    """
    Model admin for DirectAssessmentDocumentResult instances.
    """
...
admin.site.register(DirectAssessmentDocLevelDAWindowTask, DirectAssessmentDocLevelDAWindowTaskAdmin)
admin.site.register(DirectAssessmentLongDocumentTask, DirectAssessmentLongDocumentTaskAdmin)
admin.site.register(DirectAssessmentDocumentResult, DirectAssessmentDocumentResultAdmin)
admin.site.register(DirectAssessmentDocLevelDAWindowResult, DirectAssessmentDocLevelDAWindowResultAdmin)
admin.site.register(DirectAssessmentLongDocumentResult, DirectAssessmentLongDocumentResultAdmin)
