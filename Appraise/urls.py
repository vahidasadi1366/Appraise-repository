...
urlpatterns = [
    ...
    re_path(
        r'^direct-assessment-long-document/$',
        evalview_views.direct_assessment_long_document,
        name='direct-assessment-long-document',
    ),
    re_path(
        r'^direct-assessment-long-document/(?P<code>[a-z]{3})/$',
        evalview_views.direct_assessment_long_document,
        name='direct-assessment-long-document',
    ),
    re_path(
        ...
        re_path(
        r'^direct-assessment-document-window/$',
        evalview_views.direct_assessment_DocLevelDA_Window,
        name='direct-assessment-document-window',
    ),
        path(
        r'direct-assessment-document-window/<int:index>/',
        evalview_views.direct_assessment_DocLevelDA_Window,
        name='direct-assessment-document-window',
    ),
    re_path(
        r'^direct-assessment-document-window/(?P<code>[a-z]{3})/$',
        evalview_views.direct_assessment_DocLevelDA_Window,
        name='direct-assessment-document-window',
    ),
    re_path(
