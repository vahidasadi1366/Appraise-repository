...
# {<class 'EvalData.models.direct_assessment.DirectAssessmentTask'>: 'direct', <class 'EvalData.models.direct_assessment_context.DirectAssessmentContextTask'>: 'doclevelda', <class 'EvalData.models.direct_assessment_document.DirectAssessmentDocumentTask'>: 'document', <class 'EvalData.models.direct_assessment_long_document.DirectAssessmentLongDocumentTask'>: 'longdocument', <class 'EvalData.models.direct_assessment_DocLevelDA_Window.DirectAssessmentDocLevelDAWindowTask'>: 'doclevelda-window', <class 'EvalData.models.multi_modal_assessment.MultiModalAssessmentTask'>: 'multimodal', <class 'EvalData.models.pairwise_assessment.PairwiseAssessmentTask'>: 'pairwise', <class 'EvalData.models.pairwise_assessment_document.PairwiseAssessmentDocumentTask'>: 'pairwisedocument', <class 'EvalData.models.data_assessment.DataAssessmentTask'>: 'data'}
print('TASK_NAMES', TASK_NAMES)
TASK_URLS = {tup[0].lower(): tup[3] for tup in TASK_DEFINITIONS}
# TASK_URLS {'direct': 'direct-assessment', 'doclevelda': 'direct-assessment-context', 'document': 'direct-assessment-document', 'longdocument': 'direct-assessment-long-document', 'doclevelda-window': 'direct-assessment-document-window', 'multimodal': 'multimodal-assessment', 'pairwise': 'pairwise-assessment', 'pairwisedocument': 'pairwise-assessment-document', 'data': 'data-assessment'}
print('TASK_URLS', TASK_URLS)
...
def dashboard(request):
    ...
    print('  Current task1: {0}'.format(current_task))
    ...
    if not current_task:
        ...
        for agenda in agendas:
            ...
            for serialized_open_task in agenda.serialized_open_tasks():
                ...
                if open_task.next_item_for_user(request.user) is not None:
                    ...
                    print('555555555555555555555', current_task)
        ...
        if not current_task and agendas.count() > 0:
            ...
            work_completed = True
    print('  Current task2: {0}'.format(current_task))
    ...
    # if current_type == 'doclevelda-window' :
